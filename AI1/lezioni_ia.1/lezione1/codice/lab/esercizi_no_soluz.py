...
### Soluzione:
print("***ESERCIZIO 2***")
print("Shape: ", df.shape) #idea di estensione
print("Data types: ", df.dtypes) #tipo di dato 
print(df.info())
print("*****************"+"\n")
...
# print(f"Artist {longest_album['Artist']}, Title {longest_album['Album']}, Length {longest_album}")
shortest_album = df.loc[df['Length_timedelta'].idxmin()]
print(shortest_album)
print(longest_album)
# print(f"Artist {shortest_album['Artist']}, Title {shortest_album['Title']}, Length {shortest_album}")
print("*****************"+"\n")
...
print(condition_y[['Artist', 'Album']])
#oppure
...
best_seller = non_soundtrack.lod[non_soundtrack['Music Recording Sales (millions)'].idxmax()]
